...
// static const char *rcmd[] = { "rofi","-show","drun"};
static const char *termcmd[]  = { "st", NULL };
static const char *volumecmd[] = { "pavucontrol"};
static const char *volunmutecmd[] = {".config/dunst/volume.sh", "unmute", NULL};
static const char *volmutecmd[] = {".config/dunst/volume.sh", "mute", NULL};
static const char *volupcmd[] = {".config/dunst/volume.sh", "up", NULL};
static const char *voldowncmd[] = {".config/dunst/volume.sh", "down", NULL};
